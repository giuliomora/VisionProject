...
class TacticalViewConverter:
    ...
    def validate_keypoints(self, keypoints_list):
        """Valida i keypoint confrontando le distanze proporzionali con il campo tattico."""
    ...
    def transform_players_to_tactical_view(self, keypoints_list, player_tracks):
        """Trasforma le posizioni dei giocatori dalle coordinate video a quelle del campo tattico."""
