...
class PassInterceptionDrawer:
    """Draw pass and interception statistics on video frames."""
    def __init__(self):
        pass

    def get_stats(self, passes, interceptions):
        """Count passes/interceptions per team. Returns (t1_p, t2_p, t1_i, t2_i)."""
        team1_passes = []
        team2_passes = []
        team1_interceptions = []
        team2_interceptions = []
    ...
    def draw_frame(self, frame, frame_num, passes, interceptions):
        """Draw semi-transparent overlay with stats on single frame."""
        overlay = frame.copy()
        font_scale = 0.7
        font_thickness = 2
