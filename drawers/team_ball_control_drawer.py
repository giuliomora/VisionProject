...
class TeamBallControlDrawer:
    ...
    def get_team_ball_control(self,player_assignment,ball_aquisition):
        """Return array of team control per frame (1=Team1, 2=Team2, -1=none)."""
    ...
    def draw(self,video_frames,player_assignment,ball_aquisition):
        """Draw team ball control percentages on video frames."""
    ...
    def draw_frame(self,frame,frame_num,team_ball_control):
        """Draw semi-transparent overlay with ball control percentages on single frame."""
        
        # Semi-transparent overlay setup
        overlay = frame.copy()
        font_scale = 0.7
        font_thickness=2
