...
class TeamBallControlDrawer:
    """Calcola e disegna le statistiche di controllo palla per squadra."""
    def __init__(self):
        pass

    def get_team_ball_control(self,player_assignment,ball_aquisition):
        """Calcola quale squadra ha il controllo palla per frame."""
    ...
    def draw(self,video_frames,player_assignment,ball_aquisition):
        """Disegna le statistiche di controllo palla su tutti i frame."""
    ...
    def draw_frame(self,frame,frame_num,team_ball_control):
        """Disegna l'overlay con percentuali di controllo palla su singolo frame."""
        ...
        # Conta i frame di controllo palla per squadra
